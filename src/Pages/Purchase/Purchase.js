                        ...
                        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
                                ...
                                <div class="flex ml-6 items-center">
                                    ...
                                    <input type="text" placeholder="Minimum Quantity" defaultValue={product?.minOrder} {...register("quantity")} class="input w-full max-w-xs" />
                                </div>
                            </div>
                            <div class="flex">
                                <span class="title-font font-medium text-2xl">${product?.price}/unit</span>
                                <button class="flex ml-auto       bg-primary border-0 py-2 px-6 focus:outline-none hover:bg-accent rounded">Purchase</button>
                                <button class="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center ml-4">
                                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
