                        ...
                        <li>
                            <div className="mt-3 ml-6">
                                <div className="input-group relative flex  items-stretch w-full mb-4">
                                    ...
                                    <button className="btn inline-block border-0 px-6 py-2.5 bg-primary text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-secondary hover:shadow-lg   focus:shadow-lg  focus:ring-0active:shadow-lg transition duration-150 ease-in-out flex items-center" type="button" id="button-addon2">
                    ...
                    <div className="dropdown dropdown-end">
                        <label tabindex="0" className="btn btn-ghost btn-circle">
                            <div className="indicator">
                                ...
                                <span className="badge badge-sm indicator-item">{data?.length && user?.email ? data.length : 0}</span>
                            </div>
                        </label>
                        <div tabindex="0" className="mt-3 card card-compact dropdown-content w-52 bg-base-100 shadow">
                            <div className="card-body">
                                <span className="font-bold text-lg text-primary">{data?.length && user?.email ? data.length : 0} Items</span>
                                <span className="font-bold text-lg text-accent">Subtotal: <span className='text-primary'>{data?.length && user?.email ? totalPrice : 0}</span> $</span>

                                <div className="card-actions">
                                    <Link to='/dashboard/myOrders' className="btn btn-primary btn-block">View cart</Link>
                                </div>
                            </div>
                        </div>
                    </div>
